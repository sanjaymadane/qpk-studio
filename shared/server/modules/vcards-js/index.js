 ...
 */
var vCard = (function (type) {

  var fs   = require('fs');
  var path = require('path');
  var exportType = require('./export_type')(type || 'apple');  
    /**
    ...
    /**
     * Get instant messaging ids
     * @return {object} Instant messaging hash group
     */
    function getInstantMessagingGroups() {
        return {
            'google_talk': '',
            'qq': '',
            'msn': '',
    ...
    return {
        ...
        /**
        *   Instant Messagin ids
        *   @type {object}
        */
        ims: getInstantMessagingGroups(),
        ...
        getFormattedString: function() {
            ...
            return vCardFormatter.getFormattedString(this, exportType);
        },
