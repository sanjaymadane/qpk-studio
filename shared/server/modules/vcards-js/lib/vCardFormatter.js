...
(function vCardFormatter() {
    ...
    module.exports = {
         ...
         */
        getFormattedString: function(vCard, exportType) {
            ...
            if (vCard.birthday) {
                formattedVCardString += 'BDAY:' + moment(vCard.birthday).format('DDMMYYYY') + nl();
            }
            ...
            if(vCard.email) {
                var arrstrEmail = exportType.getEmail(vCard.email);
                if( arrstrEmail.length > 0 ) {
                    formattedVCardString += arrstrEmail.join(nl()) + nl();
                }
            }
            ...
            if (vCard.phone) {
                ...
                // }
                // console.log(vCard.phone);
                var arrstrPhone = exportType.getPhone(vCard.phone);

                if( arrstrPhone.length > 0 ) {
                    formattedVCardString += arrstrPhone.join(nl()) + nl();
                }
            }
            ...
            if (vCard.url) {
                var arrstrWebPage = exportType.getWebPage(vCard.url);
                if( arrstrWebPage.length > 0 ) {
                    formattedVCardString += arrstrWebPage.join(nl()) + nl();
                }                
            }
            ...
            if(vCard.ims) {                
                var arrstrIm = exportType.getIm(vCard.ims);
                if( arrstrIm.length > 0 ) {
                    formattedVCardString += arrstrIm.join(nl()) + nl();
                }
            }
