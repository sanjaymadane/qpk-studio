...
var sourcesSchema = new mongoose.Schema({
  label: String,
  value: String,
  source_id: String, //will hold the id of the source if present
  metadata: {}
});
...
var mergeSchema = new mongoose.Schema({
  merged_on: { type: Date, default: Date.now },
  contacts: [contactSchema],
  user_id: String,
  merged_contact: contactSchema,
  restore_ids: Array
});

mongoose.model('MergeHistory', mergeSchema);